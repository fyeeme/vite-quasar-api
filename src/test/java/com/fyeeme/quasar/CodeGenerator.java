...
public class CodeGenerator {
     ...
     * 如输入表名称 "user_detail" 将生成 UserDetail、UserDetailMapper、UserDetailService ...
     *
...
//        delete mapper.xml
        delResourceMapperDir(tableNames);
    ...
    public static void genModelAndMapper(String tableName, String modelName) {
        ...
        pluginConfiguration.addProperty("mappers", "ResourceRepository");
        context.addPluginConfiguration(pluginConfiguration);

        JavaModelGeneratorConfiguration javaModelGeneratorConfiguration = new JavaModelGeneratorConfiguration();
        javaModelGeneratorConfiguration.setTargetProject(PROJECT_PATH + JAVA_PATH);
        javaModelGeneratorConfiguration.setTargetPackage(modelPackage(tableName));
        ...
        javaClientGeneratorConfiguration.setTargetPackage(repositoryPackage(tableName));
...
//
            File file = new File(PROJECT_PATH + JAVA_PATH + packageConvertPath(servicePackage(modelNameUpperCamel)) + modelNameUpperCamel + "Service.java");
            ...
            File file1 = new File(PROJECT_PATH + JAVA_PATH + packageConvertPath(servicePackage(modelNameUpperCamel)) + modelNameUpperCamel + "ServiceImpl.java");
    ...
    public static void genController(String tableName, String modelName) {
        try {
            ...
            File file = new File(PROJECT_PATH + JAVA_PATH + packageConvertPath(controllerPackage(modelNameUpperCamel)) + modelNameUpperCamel + "Controller.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
    ...
    public static void genRepository(String tableName, String modelName) {
        try {
            ...
            File file = new File(PROJECT_PATH + JAVA_PATH + packageConvertPath(repositoryPackage(modelNameUpperCamel)) + modelNameUpperCamel + "Repository.java");
            if (!file.getParentFile().exists()) {
                file.getParentFile().mkdirs();
            }
            //cfg.getTemplate("controller-restful.ftl").process(data, new FileWriter(file));
