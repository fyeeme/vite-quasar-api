...
public enum ErrorCode {
    ...
    USER_PHONE_CONFLICT(HttpStatus.CONFLICT, "User Phone Conflict"),
    USER_EMAIL_CONFLICT(HttpStatus.CONFLICT, "User Email Conflict"),
    USER_ID_CARD_CONFLICT(HttpStatus.CONFLICT, "User Id Card Conflict"),

    USER_PHONE_BAD_REQUEST(HttpStatus.BAD_REQUEST, "User Phone Bad Request"),
